...
const About = ({ experiences, skills }: Props) => {
        ...
        <div>
            ...
            <div className="grid-cols-1">
                                        ...
                                        <blockquote className="mt-8">
                                            <div className="relative text-lg font-medium text-white md:flex-grow">
                                                ...
                                                <p className="relative">
                                                    At MSNT, we offer guidance and direction while delivering on our customer's wireless needs. We strive for quality above all else.  
                                                </p>
                                            </div>

                                            <footer className="mt-4">
                                                <p className="text-base font-semibold text-indigo-200">Miguel Susanibar, MSNT</p>
                                            </footer>
                                        </blockquote>
                                    </div>
                                </div>
                ...
                <div className="right-0">
                    <img alt="" className="right-0" src={urlFor(experiences[0].companyImage).url()}
                    />
                </div>
            </div>
